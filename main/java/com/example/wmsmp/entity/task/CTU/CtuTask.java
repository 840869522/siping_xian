...
/**
 * 
 * @TableName t_task_ctu
 */
@TableName(value ="t_task_ctu")
@Data
public class CtuTask implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getOrg_position() == null ? other.getOrg_position() == null : this.getOrg_position().equals(other.getOrg_position()))
            && (this.getTarget_position() == null ? other.getTarget_position() == null : this.getTarget_position().equals(other.getTarget_position()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOrg_position() == null) ? 0 : getOrg_position().hashCode());
        result = prime * result + ((getTarget_position() == null) ? 0 : getTarget_position().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", org_position=").append(org_position);
        sb.append(", target_position=").append(target_position);
