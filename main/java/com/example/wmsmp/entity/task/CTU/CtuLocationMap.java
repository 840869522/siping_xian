...
/**
 * 
 * @TableName t_ctu_location_map
 */
@TableName(value ="t_ctu_location_map")
@Data
public class CtuLocationMap implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        CtuLocationMap other = (CtuLocationMap) that;
